#!/usr/bin/env python3
"""
Retrain Tutor Model with Better Data

This script retrains your tutor model using the comprehensive, high-quality
tutoring data instead of the basic MMLU multiple-choice questions.
"""
...
OUTPUT_DIR = "tutor_model_ap_focused"
MAX_SEQ_LENGTH = 2048

# Use the AP-focused combined data
...
def main():
    print("="*60)
    print("🎓 Retraining Tutor Model with Better Data")
    print("="*60)
    
    # Check if comprehensive data exists
    if not os.path.exists(TRAIN_PATH):
        print(f"❌ Training data not found: {TRAIN_PATH}")
        print("Please run: python build_comprehensive_tutor_data.py")
        return
    ...
    print("🚀 This will take a while with GPU acceleration...")
    ...
    print(f"3. Test the improved responses!")
